...
function add(c, args)
    ...
    local bts = util.table.join(
        ...
        -- TODO: Add properly-defined focus switching to lower
        abutton({ }, 2, function (w, t) t.client:lower() end),
...
-- Note: For WMs with buttons on the right-hand side, de facto standard order is
-- "minimize, maximize, close" from left to right.
