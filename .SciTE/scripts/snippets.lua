...
if scite_Command then
  scite_Command 'Insert|dostring modules.scite.snippets.insert()|Ctrl+Space'
  scite_Command 'Cancel|dostring modules.scite.snippets.cancel_current()|Ctrl+Shift+Space'
  scite_Command 'List|dostring modules.scite.snippets.list()|Ctrl+Alt+Space'
end